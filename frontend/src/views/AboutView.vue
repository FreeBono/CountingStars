  ...
  export default {
    ...
    setup() {
      ...
      async function abc() {
        ...
        // client.add(JSON.stringify(jsonn)).then(res => console.log(res)).catch(err => console.log(err))
        // console.log(2)
        // axios({
        //   method: 'post',
        ...
        axios({
          method: 'post',
          url : `http://127.0.0.1:5001/api/v0/cat?arg=QmbaGCKncEvRzbwFrnQFU3aYYFnfw9kT3TxMTDLwuyFzcS`
        })
        .then(res => console.log(res.data))
        .catch(err => console.log(err))
