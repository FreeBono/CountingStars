<template>
  <body style="width:400px; margin: 0 auto;">
    <div style="height:36.4px; marign-top:40px; margin-bottom:30px; font-size:26px;" class="join_tit">
      ...
      <div class="join_tbox_txt" style="margin-bottom:40px;"> 본인 인증이 완료되었습니다! </div>
...
<div id="container" style="margin-top:250px;">
  ...
  <form action="#" method="post" id="contact_form">
    ...
    <div class="name">
      <label for="name"></label>
      <input type="text" placeholder="PASSWORD" name="name" id="name_input" required>
    </div>
    <div class="email">
      <label for="email"></label>
      <input type="email" placeholder="PASSWORD CONFIRMATION" name="email" id="email_input" required>
    </div>
    <div class="telephone">
      <label for="name"></label>
      <input type="text" placeholder="E-mail" name="telephone" id="telephone_input" required>
...
<script>
import Address from '../../components/accounts/Address.vue'
