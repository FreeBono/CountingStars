                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody 
                      ...
                      <tr>
                        ...
                        <td>
                          <p class="mb-0 notice-title" style="font-size: 1rem;">{{ noticeitem.title }}</p>
                        </td>
                        <td>
...
export default {
  ...
  setup() {
    ...
    const pageClick = () => {
      ...
      axios({
        method: 'get',
        url: `${도메인}/api/v1/notice?page=${currentPage.value}&size=10`
      })
      .then((res) => {
    ...
    const goNoticeDetail = (noticeIdx) => {
      ...
      axios({
        method: 'get',
        url: `${도메인}/api/v1/notice/${noticeIdx}`
      })
      .then((res) => {
        console.log(res,'디테일로 가는지 확인')
        
        router.push({name: 'NoticeDetail', params: {noticeIdx}})
      })
    }
